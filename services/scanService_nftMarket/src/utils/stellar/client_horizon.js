...
class HorizonClient {
    ...
    async getTransactionDetails(txHash) {
        ...
        try {
            const response = await axios.post('https://soroban-testnet.stellar.org', requestBody, {
                headers: {
                    'Content-Type': 'application/json',
                },
            });
            // console.log(`getTransactionDetails(${txHash}) result: `, response.data);
            return response.data.result;
        } catch (e) {
            console.error("Catch error getTransactionDetails() :", e);
            throw e;
        }
    }
